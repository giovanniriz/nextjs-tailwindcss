...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Rizki Gio Portfolio</title>
      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className=" min-h-screen">
          <nav className=" py-10 mb-12 flex justify-between">
            <h1 className="text-xl font-burtons">Develop by Gio</h1>
          ...
          <div className="text-center p-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-md mx-auto">
              Freelancer providing services for programming and _ needs. Join me
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800">
              I offer from a wide range of services, includes programming and
              teaching
            </p>
          </div>
          <div className="lg:flex gap-10">
            <div className="text-center shadow-2xl p-10 rounded-xl my-10 dark:bg-white">
              ...
              <h3 className="text-lg font-medium pt-8 pb-2 dark:text-red-600">
                Beautiful Design
              </h3>
              <p className="py-2">
